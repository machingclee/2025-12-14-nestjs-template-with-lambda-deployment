...
exports.injectAuthLogicIntoSwagger = injectAuthLogicIntoSwagger;
function injectAuthLogicIntoSwagger(app) {
    app.use('/api', (req, res, next) => {
        if (req.url.includes('swagger-ui-init.js') ||
            req.url.includes('swagger-initializer.js')) {
            const originalSend = res.send;
            res.send = function (data) {
                const modifiedData = data.replace('window.ui = ui', `window.ui = ui
...
//# sourceMappingURL=injectAuthLogicIntoSwagger.js.map